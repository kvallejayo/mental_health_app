...
class ModifySleepRecordPage extends StatefulWidget {
  final String idSend;
  final SleepRecord sleepRecord;

  ModifySleepRecordPage(this.idSend, this.sleepRecord);

  @override
  State<ModifySleepRecordPage> createState() => _ModifySleepRecordPageState();
}

class _ModifySleepRecordPageState extends State<ModifySleepRecordPage> {
  ...
  @override
  void initState() {
    startDate = DateTime.parse(widget.sleepRecord.startDate);
    endDate = DateTime.parse(widget.sleepRecord.endDate);
    controllerDescription.text = widget.sleepRecord.message;
    setState(() {});
    super.initState();
  }
                            ...
                            child: Column(
                              children: [
                                ...
                                MyInputField(
                                  ...
                                  labelText: "Descripción de sueño",
                                ...
                                ElevatedButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    await dataBaseHelper.updateSleepRecord(
                                      ...
                                      desc: "¡Se modificó con exito sus horas de sueño!",
                                      buttons: [
                                        DialogButton(
                                          color: waterGreen,
                                          child: Text(
